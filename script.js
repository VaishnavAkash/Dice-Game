...
// let activePlayer= 0;
// const points= [0,0];
// let cuurent0Points= 0;
// let current1Points= 0;
...
// player0Name.nextElementSibling.innerText= points[0];  
// player1Name.nextElementSibling.innerText= points[1]; 
...
//   if(num===1){
//     if(activePlayer==0) currentScore0.innerText= 0;
//     else currentScore1.innerText= 0;
...
//     points[activePlayer]+= num;
//   }
//   else{
//     if(activePlayer==0) currentScore0.innerText= parseInt(currentScore0.innerText)+num;
//     else currentScore1.innerText= parseInt(currentScore1.innerText)+num;
//   }
// }

// dice.classList.add('hidden');
// rollDice.addEventListener('click',rolledDice);
